...
//            var userCheck = await _appDbContext.Set<User>().FirstOrDefaultAsync(u => u.Username == user.UserEmail );
//            //if (userCheck == null || !BCrypt.Net.BCrypt.Verify(user.Password))
//            //{
//            //    return new
//            //    {
//            //        status = 401,
...
//            var accessToken = await _jwtService.Authenticate(userCheck.Id, userCheck.Id, userCheck.FirstName, userCheck.LastName, userCheck.Roles);
